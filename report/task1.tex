...
\Solution{
	\begin{itemize}
		...
		class $\gamma_{nk}$, that are the posterior probabilities, can be 
		computed using Bayes with the following expression:
		\begin{equation}
			\gamma_{nk} =
		...
		\item[(c)] 
		The M-step consists in re-estimate the class parameters using new 
