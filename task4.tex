...
\Solution{
	\begin{itemize}
		...
		\begin{align*}
			l_1(c_1) & = \min_{c_1} \big((0-{c_1})^2 + (1-{c_1})^2\big) = 
			\min_{c_1} \big( 2 {c_1}^2 - 2 {c_1} + 1 \big) \\
			l_2(c_2) & = \min_{c_2} \big((0-{c_2})^2 + (0-{c_2})^2\big) = 
			\min_{c_2} \big(2{c_2}^2\big)  \\
			l_3(c_3) & = \min_{c_3} \big((1-{c_3})^2 + (0-{c_3})^2\big) = 
			\min_{c_3} \big(2{c_3}^2 -2{c_3} +1 \big) 
		\end{align*}
